...
@Controller
public class MyIssueHandler implements CommandHandler{
	...
	@RequestMapping("CI_View/issuePage/myIssue")
	@Override
	public ModelAndView process(HttpServletRequest request, HttpServletResponse respones) throws Throwable {
		
		int pageSize = 9; 			// 한 페이지의 출력할 갯수
		int pageBlock = 3;			// 한 페이지에 나타낼 페이지 갯수
		...
		return new ModelAndView("issuePage/myIssue");
	}
}
