                        ...
                        <div class="row justify-content-center" style="margin-bottom: 30px;">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                    <!-- ============== 여기부터 form  -->
                                        <form action="issuePage/issueWritePro.do" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="issueTitle" type="text" placeholder="title" />
                                                <label>제목</label>
                                            </div>
                                             <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                    <textarea style="width:100%; height:300px;"  name="issueContent" placeholder="  업무 내용"></textarea>
                                            </div>
                                                <div>
